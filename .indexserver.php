...
// $sql = "select * from pet_phc_vaccine where utemp = 0 and recall = 0";
// $l = $db->all($sql);
...
//   $note = $a[2];
//   $sql = "update pet_phc_vaccine set recall = $date, note = 'note' where id = $r[id]";
//   echo "$sql ($note) <br>";
// }

$json = json_decode('{"pet_phc_account":["id","time","content"],"pet_phc_accountname":["id","name"],"pet_phc_blood_import":["id","time","price","number1","note","doctor","number2","number3"],"pet_phc_blood_row":["id","time","number","start","end","doctor","target"],"pet_phc_config":["id","module","name","value","alt"],"pet_phc_customer":["id","name","phone","address","password","session"],"pet_phc_doctor":["id","name","userid"],"pet_phc_drug":["id","code","name","unit","system","limits","effect","effective","disease","note","sideeffect","mechanic","image"],"pet_phc_exam":["id","userid","customerid","treatid","typeid","image","note","time","status"],"pet_phc_exam_type":["id","name","active"],"pet_phc_his_temp":["id","name","phone","treat","userid","time"],"pet_phc_hotel":["id","customerid","catid","health","cometime","calltime","returntime","image","returnimage","returnuserid","status"],"pet_phc_hotel_cat":["id","name","price","active"],"pet_phc_import":["id","time","price","note","userid","module"],"pet_phc_item":["id","catid","name","code","shop","storage","border","image","outstock","recuserid","rectime","lowonnumber"],"pet_phc_item_cat":["id","name"],"pet_phc_item_expire":["id","rid","number","expire","time"],"pet_phc_item_pos":["id","name","image"],"pet_phc_item_pos_item":["posid","itemid"],"pet_phc_item_recommend":["id","content","number","name","phone","userid","status","time","image"],"pet_phc_item_source":["id","name"],"pet_phc_item_source_item":["sourceid","itemid"],"pet_phc_kaizen":["id","userid","problem","solution","result","post_time","edit_time","active","done","image"],"pet_phc_luong":["id","doanhthu","tienchi","loinhuan","thoigian","trangthai"],"pet_phc_luong_nhanvien":["id","userid","tile","luongcoban","lenluong","hopdong","camket","cophan"],"pet_phc_luong_tienchi":["id","luongid","mucchi","tienchi"],"pet_phc_luong_tra":["id","userid","luongid","doanhthu","luong","thuong","phucap","nghiphep","tietkiem","nhantietkiem","cophan","tong","thucnhan"],"pet_phc_manual":["id","title","module"],"pet_phc_manual_row":["id","type","content","manualid"],"pet_phc_notify":["id","userid","status","content","module","time"],"pet_phc_pet":["id","name","customerid"],"pet_phc_physical":["id","customer","phone","address","name","weight","age","gender","species","serial","sampletype","samplenumber","samplesymbol","samplestatus","doctor","time","symptom","image"],"pet_phc_physical_data":["id","pid","tid","value"],"pet_phc_price":["id","name","unit"],"pet_phc_price_detail":["id","itemid","name","price"],"pet_phc_profile":["id","customer","phone","address","name","weight","age","gender","species","serial","sampletype","samplenumber","samplesymbol","samplestatus","doctor","time","symptom","image"],"pet_phc_profile_data":["id","pid","tid","value"],"pet_phc_remind":["id","name","value","active","rate"],"pet_phc_ride":["id","userid","clockf","clocke","money","destination","note","time"],"pet_phc_row":["id","type","user_id","time","reg_time"],"pet_phc_session":["id","userid","session","time"],"pet_phc_sieuam":["id","userid","customerid","image","note","time"],"pet_phc_spa":["id","doctorid","customerid","customerid2","note","time","utime","image","dimage","status","weight","ltime","luser","duser","rate","treat","number"],"pet_phc_spa_row":["id","typeid","spaid"],"pet_phc_spa_schedule":["id","customerid","image","note","time","ctime","status"],"pet_phc_spa_type":["id","name"],"pet_phc_target":["id","name","number","active","unit","flag","intro","up","down","disease","aim","module"],"pet_phc_transport":["id","name","phone","address"],"pet_phc_type":["id","name","code","active"],"pet_phc_user":["id","userid","manager","except","daily","kaizen","session","spa"],"pet_phc_users":["userid","username","name","password","photo","regdate","session","fullname","active"],"pet_phc_user_per":["id","userid","module","alt","type"],"pet_phc_usg":["id","userid","cometime","calltime","recall","number","called","image","status","note","time","customerid","utemp"],"pet_phc_vaccine":["id","typeid","cometime","calltime","note","status","recall","userid","time","petid","called","utemp"],"pet_phc_work":["id","cometime","calltime","last_time","post_user","edit_user","userid","depart","customer","content","process","confirm","review","note","active","image"],"pet_phc_xquang":["id","userid","customerid","image","note","time"],"pet_phc_xray":["id","petid","doctorid","diseaseid","insult","time","rate","share","pos"],"pet_phc_xray_chat":["id","postid","side","time","text"],"pet_phc_xray_disease":["id","name","active"],"pet_phc_xray_his":["id","petid","his","time"],"pet_phc_xray_read":["id","userid","postid","side","time"],"pet_phc_xray_row":["id","xrayid","temperate","subother","other","image","time","treat","status","doctorid","pay","xquang","sinhly","sinhhoa","sieuam","nuoctieu","conclude"],"pet_phc_xray_schedule":["id","xrayid","time","status"]}');
