...
$json = json_decode('{"pet_test_account":["id","time","content"],"pet_test_accountname":["id","name"],"pet_test_config":["id","module","name","value","alt"],"pet_test_customer":["id","name","phone","address","password","session"],"pet_test_drug":["id","code","name","unit","system","limits","effect","effective","disease","note","sideeffect","mechanic","image"],"pet_test_exam":["id","userid","customerid","treatid","typeid","image","note","time","status"],"pet_test_exam_type":["id","name","active"],"pet_test_form":["id","name","value"],"pet_test_hotel":["id","customerid","catid","health","cometime","calltime","returntime","image","returnimage","returnuserid","status"],"pet_test_hotel_cat":["id","name","price","active"],"pet_test_import":["id","time","price","note","userid","module"],"pet_test_item":["id","catid","name","code","shop","storage","border","image","outstock","recuserid","rectime","lowonnumber"],"pet_test_item_cat":["id","name"],"pet_test_item_expire":["id","rid","number","expire","time"],"pet_test_item_pos":["id","name","image"],"pet_test_item_pos_item":["posid","itemid"],"pet_test_item_recommend":["id","content","number","name","phone","userid","status","time","image"],"pet_test_item_source":["id","name"],"pet_test_item_source_item":["sourceid","itemid"],"pet_test_kaizen":["id","userid","problem","solution","result","post_time","edit_time","active","done","image","noidungdongdoi","hinhanhdongdoi","noidungtugiac","hinhanhtugiac"],"pet_test_luong":["id","doanhthu","loinhuan","tienchi","luongnhanvien","lairong","thoigian","trangthai"],"pet_test_luong_nhanvien":["id","userid","tile","luongcoban","lenluong","hopdong","camket","cophan","phucap","phucap2"],"pet_test_luong_tienchi":["id","luongid","mucchi","tienchi"],"pet_test_luong_tra":["id","userid","luongid","doanhthu","loinhuan","luong","tile","tilethuong","thuong","luongphucap","phucap2","phucap","ngaynghi","nghiphep","tietkiem","nhantietkiem","tilecophan","cophan","tong","thucnhan"],"pet_test_manual":["id","title","module"],"pet_test_manual_row":["id","type","content","manualid"],"pet_test_notify":["id","userid","status","content","module","time"],"pet_test_pet":["id","name","customerid"],"pet_test_physical":["id","customer","phone","address","name","weight","age","gender","species","serial","sampletype","samplenumber","samplesymbol","samplestatus","doctor","time","symptom","image"],"pet_test_physical_data":["id","pid","tid","value"],"pet_test_price":["id","name","unit"],"pet_test_price_detail":["id","itemid","name","price"],"pet_test_profile":["id","customer","phone","address","name","weight","age","gender","species","serial","sampletype","samplenumber","samplesymbol","samplestatus","doctor","time","symptom","image"],"pet_test_profile_data":["id","pid","tid","value"],"pet_test_remind":["id","name","value","active","rate"],"pet_test_ride":["id","userid","clockf","clocke","money","destination","note","time"],"pet_test_row":["id","type","user_id","time","reg_time"],"pet_test_row_log":["id","userid","type","time","reg_time","reg_type"],"pet_test_session":["id","userid","session","time"],"pet_test_sieuam":["id","userid","customerid","image","note","time"],"pet_test_spa":["id","doctorid","customerid","customerid2","note","time","utime","image","dimage","status","weight","ltime","luser","duser","rate","treat","number"],"pet_test_spa_row":["id","typeid","spaid"],"pet_test_spa_schedule":["id","customerid","image","note","time","ctime","status"],"pet_test_spa_type":["id","name"],"pet_test_target":["id","name","number","active","unit","flag","intro","up","down","disease","aim","module"],"pet_test_transport":["id","name","phone","address"],"pet_test_type":["id","name","code","active"],"pet_test_users":["userid","username","name","password","photo","regdate","session","fullname","active","placeid","birthday"],"pet_test_user_per":["id","userid","module","alt","type"],"pet_test_usg":["id","userid","cometime","calltime","recall","number","called","image","status","note","time","customerid","utemp"],"pet_test_vaccine":["id","typeid","cometime","calltime","note","status","recall","userid","time","petid","called","utemp"],"pet_test_work":["id","userid","departid","title","content","file","time","createtime","expiretime","updatetime","status"],"pet_test_work_assign":["id","workid","userid"],"pet_test_work_comment":["id","workid","userid","comment","file","time"],"pet_test_work_depart":["id","name","parentid","active"],"pet_test_work_depart_user":["id","departid","userid"],"pet_test_work_follow":["id","userid","workid"],"pet_test_work_repeat":["id","workid","type","time","list","status"],"pet_test_xquang":["id","userid","customerid","image","note","time"],"pet_test_xray":["id","doctorid","insult","time","rate","share","pos","customerid","petname","weight","age","species","gender"],"pet_test_xray_chat":["id","postid","side","time","text"],"pet_test_xray_disease":["id","name","active"],"pet_test_xray_his":["id","petid","his","time"],"pet_test_xray_read":["id","userid","postid","side","time"],"pet_test_xray_row":["id","xrayid","temperate","subother","other","image","time","treat","status","doctorid","pay","xquang","sieuam","sinhly","sinhhoa","nuoctieu","conclude"],"pet_test_xray_schedule":["id","xrayid","time","status"]}');
