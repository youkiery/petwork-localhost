...
//   $result['status'] = 1;
//   $result['tilespa'] = laytilespa($data->idnguoidung);
//   $result['tilebanhang'] = laytilebanhang2($data->idnguoidung);
//   $result['heluong'] = layheluong($data->idnguoidung);
//   $result['dulieunhanvien'] = dulieunhanvien($data->idnguoidung);
//   $result['luongcoban'] = luongcoban($data->idnguoidung);
//   $result['phucap'] = phucap($data->idnguoidung);
//   $result['luong'] = luongthangnay($data->idnguoidung);
...
//   $result['status'] = 1;
//   $result['tilespa'] = laytilespa($data->idnguoidung);
//   $result['tilebanhang'] = laytilebanhang($data->idnguoidung);
